...
<div class="col-md-8 col-md-offset-2">
  ...
  <!-- NEW COMMENT FORM -->
  <form name="newCommentForm" ng-submit="submitComment()"> <!-- ng-submit will disable the default form action and use our function -->
    ...
    <div class="form-group text-right"> 
      <button type="submit" class="btn btn-primary btn-lg" ng-disabled="newCommentForm.$invalid">Submit</button>
    </div>
  </form>
